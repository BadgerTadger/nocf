<%@ Page Title="Qualifying Criteria" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="QualifyingCriteria.aspx.cs" Inherits="QualifyingCriteria" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        <div class="col-md-12">
            <ul>
                <li>The Qualifying period for entries is 28 October 2014 – 5 October 2015.</li>
                <li>Qualifying will be based on a points system, similar to that used in the Obedience Excellent qualifications.</li>
                <li>Points will be gained for being placed 1st – 6th at any Open and Championship obedience shows held in the UK within the qualifying period above. All Qualifying Points for entry must have been earned by the dog (PB and Beg refers).</li>
                <li>
                ...
                <li>Points can be used to qualify for the class in which they are attained only – for example, points gained for places in class ‘A’ may only be accumulated to qualify for the ‘A’ Class at the National Obedience Class Finals and may not be transferred to another class, even if the dog is currently eligible to compete at the Novice level.</li>
                <li>
                ...
                <li>Handlers who have been fortunate enough to win a Championship Class ‘C’ in 2015 will not be eligible to compete in the National Obedience Class Finals at any level.</li>
                <li>Entries in all classes will be capped - See <a href="Entries.aspx">Entries</a> page.</li>
                <li>Start recording your dogs' qualifying points NOW! Download a record form in either <a href="docs/NOCF 2015 Qualifying Points form.docx">Word</a> or <a href="docs/NOCF 2015 Qualifying Points form.pdf" target="new">PDF</a> format.</li>
                <li>If you are in any doubt as to your eligibility, please <a href="mailto:nocf@btinternet.com?subject=2015&nbsp;Eligibility">contact us</a>.</li>
