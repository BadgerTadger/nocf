<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="QualifyingCriteria.aspx.cs" Inherits="Event2019_QualifyingCriteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="row">
        <div class="col-md-12">
            <ul>
                <li>The Qualifying period for entries is 2 October 2018 – 19 October 2019.</li>
                ...
                <li>Handlers who have been fortunate enough to win a Championship Class ‘C’ in 2019 will not be eligible to compete in the National Obedience Class Finals at any level.</li>
                <li>Entries in all classes will be capped - See <a href="Entries.aspx">Entries</a> page.</li>
                <li>Start recording your dogs' qualifying points NOW! Download a record form in either <a href="docs/NOCF-2019-Qualifying-Info-and-Form.docx">Word</a> or <a href="docs/NOCF-2019-Qualifying-Info-and-Form.pdf" target="new">PDF</a> format.</li>
