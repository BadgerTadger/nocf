<%@ Page Title="2019 Event" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Event2019.aspx.cs" Inherits="Event2019_Event2019" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <h2><%: Title %></h2>
    <div class="row">
        <div class="col-md-12">
            <h4>We are pleased to announce that the National Obedience Class Finals 2019 will be held at our new venue on</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h1>Saturday 30th November, 2019</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h4>Due to pre-existing bookings, we were unable to obtain a suitable date at the Kennel Club building, but we have found a new venue just 10 minutes away.<br />
                Please have a look at the announcement by downloading the PDF file <a href="docs/Sports Connexions announcement.pdf" target="_blank">here</a>.
            </h4>
        </div>
    </div>
    <div class="row">
...
<%--            <a href="../Event2016/docs/NOCF Running Orders 2016.pdf" target="new">2016 Running Orders</a><br />
        ...
        <div class="col-md-4">
            ...
            <h4>Feedback</h4>
            <p>
                If you have any feedback on the 2018 event, please do not be afraid to share it with us, using the email address at the bottom of the page...
            </p>
            <br />
            <br />
            </div>
