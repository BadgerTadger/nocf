<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Entries.aspx.cs" Inherits="Event2019_Entries" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <div>
                ...
                <ul>
                    <li>Entries open 15th September 2019</li>
                    <li>Entries close 20th October 2019 via WYD and postal entries latest postmark</li>
                </ul>
            </div>
            <div>
                <p>
            ...
            <div>
                ...
                <p>
                    Handlers who have been fortunate enough to win a Championship Class ‘C’ in 2019 will not be eligible to compete in the National Obedience Class Finals at any level.
                </p>
                <p>
                ...
                <p>
                    ...
                    in either <a href="docs/NOCF-2019-Qualifying-Info-and-Form.docx">Word</a> or <a href="docs/NOCF-2019-Qualifying-Info-and-Form.pdf" target="new">PDF</a> format.
                    </strong>
                </p>
                <p>
